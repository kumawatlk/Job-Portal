  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="profilepicform" name="profilepicform"  enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary mx-3" id="submitBtn">Update</button>
